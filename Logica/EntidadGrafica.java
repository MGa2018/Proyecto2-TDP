...
public class EntidadGrafica{
	...
	public EntidadGrafica() {
		...
		this.imagenRepetida = "/ImagenRepetida/repetida.png";
	    this.inicial = "/ImagenLisa/libre.png";
	...
	public void actualizar(int indice) {
		if (indice < this.imagenes.length) {
			...
			ImageIcon imageIcon = new ImageIcon(this.getClass().getResource(imagenRepetida));
			this.grafico.setImage(imageIcon.getImage());
		}else if (indice == 11) {//imagen para completar
			ImageIcon imageIcon = new ImageIcon(this.getClass().getResource(inicial));
			this.grafico.setImage(imageIcon.getImage());
		}
	}
